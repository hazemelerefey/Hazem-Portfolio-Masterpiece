...
# Using regex to find the exact block
# We want to replace from <!-- Project 1: Healthcare... down to right before <!-- Work Process...

pattern = re.compile(r'(<!-- Project 1: Healthcare Dashboard.*?)(<!-- Work Process Section)', re.DOTALL)
...
if match:
    ...
    print("Replaced portfolio content successfully.")
else:
